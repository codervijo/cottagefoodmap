...
export const florida: StateLaw = {
  ...
  sales_channels: {
    value: {
      ...
      retail_resale: false,
      notes: "May sell and accept payment online or by mail order, and deliver in person, to an event venue, or by USPS or commercial mail carrier. Wholesale is not allowed. Free samples must be prepackaged. Products sold must be stored on the premises. Florida's exemption covers in-state sales only; shipping to another state falls under federal (FDA) jurisdiction, which s. 500.80 can't authorize.",
    },
    source_url: FL_STATUTE,
    source_title: FL_STATUTE_TITLE,
  ...
  caveats: [
    ...
    "Section 500.80 is a state exemption: it covers sales within Florida and can't authorize shipping cottage food to another state, where federal food rules apply.",
  ],
  sources: [
